        ...
        public ActivationSequenceProvider()
        {
            ...
            var transitions =
                TransitionCollection.Builder()
                    ...
                    .RegisterTransition<GetDeviceId, GetUser, RegisterDevice>()
                    .RegisterTransition<RegisterDevice, GetUser, Failed>()
                    .RegisterTransition<GetUser, SaveUser, Failed>()
                    .RegisterTransition<SaveUser, CreateEncryptionKeys, Failed>()
                    .RegisterTransition<CreateEncryptionKeys, StartOmniService, Failed>()
