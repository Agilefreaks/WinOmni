namespace OmnipasteTests.ContactList
{
    ...
    public class ContactInfoViewModelTests
    {
        ...
        {
            var message = new SmsMessage { Time = new DateTime(2014, 1, 1), Content = "test", ContactInfo = new ContactInfo { Phone = _contactInfo.Phone } };
        ...
        {
            var message = new SmsMessage { Time = new DateTime(2014, 1, 1), Content = "test", WasViewed = true, ContactInfo = new ContactInfo { Phone = _contactInfo.Phone } };
            var call = new Call { Time = new DateTime(2013, 12, 31), Source = SourceType.Remote, ContactInfo = new ContactInfo { Phone = _contactInfo.Phone } };
            SetupConversation(message, call);
        ...
        {
            var message = new SmsMessage { Time = new DateTime(2014, 1, 1), Content = "test", WasViewed = false, ContactInfo = new ContactInfo { Phone = _contactInfo.Phone } };
            var call = new Call { Time = new DateTime(2013, 12, 31), Source = SourceType.Remote, ContactInfo = new ContactInfo { Phone = _contactInfo.Phone } };
            SetupConversation(message, call);
        ...
        {
            var message = new SmsMessage { Time = new DateTime(2013, 12, 31), Content = "test", ContactInfo = new ContactInfo { Phone = _contactInfo.Phone } };
