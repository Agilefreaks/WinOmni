namespace OmnipasteTests.Services.ActivationServiceData.ActivationServiceSteps
{
    ...
    public class FixProxyConfigurationTests
    {
        ...
        public void Execute_AProxyConfigurationDetectorReturnsADifferentConfigurationThanTheExistingOneAndCanPingWithIt_SavesTheNewConfiguration()
        {
            ...
            _mockConfigurationService.VerifySet(x => x.ProxyConfiguration = proxyConfiguration, Times.Once());
        }
        ...
        public void Execute_AllProxyConfigurationDetectorsReturnConfigurationsForWhichPingFails_SavesTheFirstNewConfiguration()
        {
            ...
            _mockConfigurationService.VerifySet(x => x.ProxyConfiguration = newProxyConfiguration);
        }
